...
const testimonials = [
  {
    quote:
      "Zenmotion didn\u2019t just edit our video, they completely elevated our brand\u2019s narrative. Their attention to rhythm and emotion is unmatched.",
    name: "Sarah Jenkins",
    title: "Creative Director, Vibe Global",
  },
  {
    quote:
      "The motion design work they delivered for our launch campaign was breathtaking. They have an innate understanding of visual pacing.",
    name: "Marcus Cole",
    title: "CMO, Nexus Tech",
  },
  {
    quote:
      "Working with Zenmotion was a masterclass in collaboration. They took our raw footage and turned it into a cinematic masterpiece.",
    name: "Elena Rodriguez",
    title: "Independent Filmmaker",
  },
  {
    quote:
      "A rare mix of technical brilliance and artistic intuition. They are our go-to studio for anything that requires a premium touch.",
    name: "David Chen",
...
export function Testimonials() {
  ...
  return (
    <section
      className="bg-background py-24 sm:py-32 overflow-hidden border-t border-white/10"
      data-cursor="DRAG"
    >
        ...
        >
          ...
          >
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="text-accent text-6xl font-heading leading-none h-12">
                  &ldquo;
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-white/50 uppercase tracking-widest mt-1">
                      {testimonial.title}
                    </div>
                  </div>
                </div>
